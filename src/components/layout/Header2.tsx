...
const Header2: React.FC<HeaderProps> = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }) => {
                        ...
                        <div className="main-box">
                            ...
                            <div className="nav-outer">
                                ...
                                <div className="action-box">
                                    ...
                                    <div className="mobile-nav-toggler" onClick={handleOpen}><div className="shape-line light" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <nav className="menu-box">
                    ...
                    <ul className="contact-list-one">
                        <li>
                            ...
                            <div className="text"><Link href="mailto:lawson@example.com">alma.lawson@example.com</Link></div>
                        </li>
                    </ul>
                ...
                <div className="auto-container">
                    <div className="inner-container">
                        ...
                        <div className="nav-outer">
                            ...
                            <div className="mobile-nav-toggler" onClick={handleOpen}><span className="icon far fa-bars" /></div>
                        </div>
                    </div>
                </div>
            </div>
