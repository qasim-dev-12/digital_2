...
const Header4: React.FC<HeaderProps> = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }) => {
  return (
    <>
    <header className={`main-header header-style-one style-three header-transparent ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
              ...
              <div className="main-box">
                ...
                <div className="nav-outer">
                  ...
                  <div className="action-box">
                    ...
                    <div className="mobile-nav-toggler" onClick={handleOpen}><div className="shape-line light"></div></div>
                  </div>
                </div>
              </div>
            </div>
