...
const Header5: React.FC<HeaderProps> = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }) => {

  return (
    <>
      <header className={`main-header header-style-one style-four ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
        <div className="outer-box">
          <div className="header-lower">
            <div className="inner-container">
              <div className="main-box">
                <div className="logo-box">
                  <div className="logo"><Link href="/"><img src="assets/images/ST Logo new1.png" alt="Logo"/></Link></div>
                </div>
                <div className="nav-outer">
                  ...
                  <div className="action-box">
                    ...
                    <div className="mobile-nav-toggler" onClick={handleOpen}><div className="shape-line-img"><img className="icon-img" src="assets/images/icons/shape-line-icon.png" alt="Image"/></div></div>
                  </div>
                </div>
              </div>
            </div>
