    ...
    return (
        ...
        <section className="testimonial-section">
          <div className="scroll-text">
            <div className="title-stroke-text text2 fadeInUpBig"><span>Testim</span>onial</div>
          </div>
          <div className="anim-icons">
            <div className="image-5 tm-gsap-img-parallax"><img src="assets/images/icons/shape-style52.png" alt="image" /></div>
          </div>
          <div className="outer-box style-two">
            <div className="bg bg-image" style={{ backgroundImage: "url(assets/images/icons/section-bg-shape17.png)" }}></div>
            <div className="container">
              <div className="sec-title text-center">
                <span className="sub-title wow fadeInUp"><img className="icon-img" src="assets/images/icons/sub-title-shape.png" alt="" /> Testimonial</span>
                <h2 className="title wow fadeInUp">Hear what others say <br />about <span className="theme-color1">partnering with us</span></h2>
              </div>
              <div className="row">
                  ...
                  <div className="review-box-2">
                    ...
                    <div className="reviews-list">
                      <div className="review">
                        <div className="logo">
                          <img src="assets/images/icons/logo-trustpilot.png" alt="" />
                        </div>
                        <div className="text">4k Reviews</div>
                      </div>
                      <div className="review">
                        <div className="logo">
                          <img src="assets/images/icons/logo-google.png" alt="" />
                        </div>
                        <div className="text">1k Reviews</div>
                      </div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="clients-section pb-0">
                <div className="sec-title text-center">
                  <div className="text"><span>1K+ Brands Trust Us</span></div>
                </div>
                        ...
                        <div className="inner-box">
                          <div className="image-box">
                            <figure className="image">
                              <Link href="#"><img src="assets/images/resource/client1-1.png" alt="Image" /></Link>
                            </figure>
                          </div>
                        </div>
                      </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="client-block">
                        <div className="inner-box">
                          <div className="image-box">
                            <figure className="image">
                              <Link href="#"><img src="assets/images/resource/client1-2.png" alt="Image" /></Link>
                            </figure>
                          </div>
                        </div>
                      </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="client-block">
                        <div className="inner-box">
                          <div className="image-box">
                            <figure className="image">
                              <Link href="#"><img src="assets/images/resource/client1-3.png" alt="Image" /></Link>
                            </figure>
                          </div>
                        </div>
                      </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="client-block">
                        <div className="inner-box">
                          <div className="image-box">
                            <figure className="image">
                              <Link href="#"><img src="assets/images/resource/client1-4.png" alt="Image" /></Link>
                            </figure>
                          </div>
                        </div>
                      </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="client-block">
                        <div className="inner-box">
                          <div className="image-box">
                            <figure className="image">
                              <Link href="#"><img src="assets/images/resource/client1-5.png" alt="Image" /></Link>
                            </figure>
                          </div>
                        </div>
                      </div>
