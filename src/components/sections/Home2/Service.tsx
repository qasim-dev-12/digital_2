...
export default function Service() {
    return (
        ...
        <section className="services-section-two">
            ...
            <div className="image-1 tm-gsap-animate-horizontal"><img src="assets/images/icons/theme-icon33.png" alt="Image" /></div>
            <div className="image-2"><img src="assets/images/icons/shape-style24.png" alt="Image" /></div>
            </div>
            <div className="scroll-text">
            <div className="title-stroke-text text2 fadeInUpBig"><span>Services</span></div>
            </div>
                ...
                <Swiper {...swiperOptions} className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                        <div className="service-block-two">
                            ...
                            <div className="content-box">
                                ...
                                <h4 className="title">
                                <Link href="/page-service-details">Web Application <br />Development</Link>
                                </h4>
                    ...
                    <div className="service-block-two">
                        ...
                        <div className="content-box">
                            ...
                            <h4 className="title">
                            <Link href="/page-service-details">Creative Content <br />Production</Link>
                            </h4>
                            <Link className="btn-link" href="/page-service-details"><i className="icon fa-solid fa-arrow-down-right"></i></Link>
                        </div>
                        </div>
                    ...
                    <div className="service-block-two">
                        ...
                        <div className="content-box">
                            ...
                            <h4 className="title">
                            <Link href="/page-service-details">Project & Product <br />Consulting </Link>
                            </h4>
                            <Link className="btn-link" href="/page-service-details"><i className="icon fa-solid fa-arrow-down-right"></i></Link>
                        </div>
                        </div>
