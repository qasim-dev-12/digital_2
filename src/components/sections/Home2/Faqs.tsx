    ...
    const faqData = [
        {
            ...
            answer: "We offer a wide range of digital services including website design, development, SEO, branding, and digital marketing tailored to your business needs."
        },
        {
            question: "How long have you been in business?",
            answer: "Our team has been providing exceptional digital solutions for over 8 years, helping businesses grow their online presence."
        },
        {
            question: "What industries do you specialize in?",
            answer: "We work with a diverse range of industries including technology, healthcare, real estate, retail, and many more."
        },
        {
            question: "Do you design custom websites?",
            answer: "Yes, we specialize in designing fully customized websites that align with your brand and meet your business goals."
        }
    ];
                        ...
                        <div className="row">
                            <div className="col-lg-7">
                                ...
                                <h2 className="title wow fadeInUp">
                                    Clear Answers, To <br className="d-none d-sm-block" /> Quick <span>Solutions</span>
                                </h2>
                            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="image-column col-lg-4">
                            <div className="faq-img tm-gsap-img-parallax">
                                <img src="assets/images/icons/shape-style13.png" alt="Shape" />
                            </div>
                        </div>
                    </div>
                </div>
