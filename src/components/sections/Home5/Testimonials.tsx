...
function Testimonials() {
    ...
    return (
        <>
        <section className="testimonial-section home-five">
            <div className="anim-icons">
            <div className="image-1"><img src="assets/images/icons/shape-style15.png" alt="Image"/></div>
            <div className="image-4 circleZoom tm-gsap-img-parallax"><img src="assets/images/icons/shape-style34.png" alt="Image"/></div>
            </div>
            <div className="container">
                <div className="sec-title">
                    <div className="row justify-items-center">
                    <div className="col-xl-7 col-lg-7">
                        <span className="sub-title wow fadeInUp"><img className="icon-img" src="assets/images/icons/sub-title-shape.png" alt="Image"/> Testimonial</span>
                    ...
                    <div className="col-xl-4 col-lg-5 offset-xl-1">
                        <p className="text ml-50">Lorem ipsum dolor sit amet, consectetuer adipiscing elit seddiam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
                    </div>
                    </div>
                </div>
                <div className="row">
