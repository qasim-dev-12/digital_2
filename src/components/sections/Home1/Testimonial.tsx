          ...
          <section className="testimonial-section">
            <div className="outer-box">
              <div className="anim-icons">
                <div className="image-1 circleZoom"><img src="assets/images/icons/shape-style50.png" alt="image" /></div>
                <div className="image-2"><img src="assets/images/icons/shape-style51.png" alt="image" /></div>
              </div>
                ...
                <div className="sec-title">
                  <div className="row">
                    ...
                    <div className="col-xxl-5 col-xl-5 col-lg-4 offset-xxl-1">
                      <p className="text">We focus on building long-term partnerships with brands by delivering reliable results, transparent communication, and creative solutions tailored to their goals.</p>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-lg-4">
                    <div className="review-box">
                      ...
                      <div className="text">Our clients trust us because we consistently deliver measurable growth and ensure a smooth experience from start to finish.</div>
                    </div>
                  </div>
                            ...
                            <div className="inner-box">
                              ...
                              <div className="info-box">
                                ...
                                <div className="user-info">
                                  ...
                                  <h4 className="name">Arjun Mehta</h4>
                                  <span className="designation">Founder, BlueStone Realty</span>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="testimonial-block">
                            <div className="inner-box">
                              ...
                              <div className="info-box">
                                ...
                                <div className="user-info">
                                  <div className="user">
                                    <h4 className="name">Sophie Laurent</h4>
                                    <span className="designation">Marketing Director, Maison Luxe Paris
</span>
                                  </div>
                                </div>
                              </div>
...
<p className='text'>“We saw a strong improvement in traffic and conversions soon after partnering with Stay Top Media. Their social media expertise and optimization made a noticeable impact on our results. They delivered strategies that kept us ahead of competitors in a fast-moving market.</p>                              <div className="info-box">
                                ...
                                <div className="user-info">
                                  <div className="user">
                                    <h4 className="name">Faisal Al Noor</h4>
                                    <span className="designation">CEO, Emirates Auto Care</span>
                                  </div>
                                </div>
                              </div>
                            </div>
...
<p className='text'>“Professional, creative, and always on time — their work helped us scale our e-commerce brand faster. Their campaigns delivered real results with improved engagement and sales. A truly valuable partner for growing Urban Threads India”</p>                              <div className="info-box">
                                ...
                                <div className="user-info">
                                  <div className="user">
                                    <h4 className="name">Mira Kapoor</h4>
                                    <span className="designation">Co-Owner, Urban Threads India</span>
                                  </div>
                                </div>
                              </div>
                            </div>
...
Their data-driven approach strengthened our visibility and lead quality.”</p>                              <div className="info-box">
                                ...
                                <div className="user-info">
                                  <div className="user">
                                    <h4 className="name">Daniel Fischer</h4>
                                    <span className="designation"> Managing Partner, Nordic Health Solutions</span>
                                  </div>
                                </div>
                              </div>
                            </div>
