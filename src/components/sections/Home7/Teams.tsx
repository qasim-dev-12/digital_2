...
function Teams() {    
    return (
        <>
            <section className="team-section-two theme-color-bg">
                <div className="anim-icons">
                        <div className="image-1 tm-gsap-img-parallax"><img src="assets/images/icons/section-bg-shape7.png" alt="Image"/></div>
                    </div>
                ...
                <div className="outer-box">
                    ...
                    <div className="col-lg-4 col-md-6">
                        ...
                        <div className="inner-box text-center">
                            ...
                            <div className="content-box style-two">
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="team-block-two" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                        <div className="inner-box text-center">
                            <div className="image-box">                            
                            <figure className="image">
                                <Link href="/page-team-details">
