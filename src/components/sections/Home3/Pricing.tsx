    ...
    return (
        ...
        <section className="pricing-section-three">
            <div className="anim-icons">
                <div className="image-1"><img src="assets/images/icons/section-bg-shape8.png" alt="Image"/></div>
            </div>
            <div className="bg bg-image" style={{ backgroundImage: "url(assets/images/icons/pattern-7.png)" }}/>
            <div className="container">
                <div className="sec-title anim-text-flip-move text-center">
                    <span className="sub-title"><img className="icon-img" src="assets/images/icons/sub-title-shape.png" alt="Image"/>Price Plan</span>
